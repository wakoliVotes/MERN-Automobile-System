...
const About = () => {
    return (
        <div className='text-center' id='aboutUs' >
            <div>
                <h2>About Us</h2>
                <h5>Welcome to the Home of Best Cars</h5>
                ...
                <div className='ourservices text-center'>
                    <h5>Our Services</h5>
                    <ul type='none' style={{ background: 'white'}}>
                        <li>Car importation from overseas</li>
                        <li>Car's inspection and valuations</li>
                        <li>Car's transportation from one region to another, by sea</li>
                        <li>Car's trade ins for specific models and makes since 2015</li>
                        <li>Car hiring for special occasions across specific timeListGroup.Itemnes</li>
                        <li>Car buying for specific models and manufacture years</li>
                        <li>Car related consultation for proper decision making</li>
                    </ul>
                </div>
            </div>
        </div>
